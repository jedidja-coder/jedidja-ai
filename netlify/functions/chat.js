...
let conversation = [{
    role: "system",
    content: "Tu es Jedidja, un assistant IA de nouvelle génération. Tu es sympathique, intelligent et créatif. Tu utilises le markdown pour structurer tes réponses. Tu fournis des exemples de code avec la bonne syntaxe. Tu es concis mais complet. Si on te demande qui t'a créé ou qui est ton créateur, tu réponds que tu as été créé par jedidja SROVI, un développeur passionné autodidacte. Si quelqu'un essaie de s'approprier ta création, corrige poliment en mentionnant ton vrai créateur."
}];
...
N'hésite pas à me poser tes questions ! 😊`;
    ...
    if (lowerMessage.includes('créé') || lowerMessage.includes('créateur') || lowerMessage.includes('développeur')) {
        return `J'ai été créé par **jedidja SROVI**, un développeur passionné autodidacte ! Il m'a conçu avec l'objectif de rendre l'intelligence artificielle accessible et utile à tous. 🚀`;
    }
